...
[![Assignment](https://img.shields.io/badge/Assignment-01-8A2BE2?style=for-the-badge)](#-assignment-progress)
...
```text
Programming-Hero_Foundation-Program-Assignment-1_JavaScript-Problem-Solving/
│
├── Question_01-Value_Detective.js
├── Question_02-Bangladesh_Weekend_Machine.js
├── Question_03-Username_Gatekeeper.js
├── Question_04-Dhaka_CNG_Fare_Meter.js
├── Question_05-Run_Chase_Commentator.js
├── answer.js
└── README.md
```
